			...
			global $current_user; wp_get_current_user();
    			...
    			if(isset($_POST["form_submit"])) {
    				...
    				if(is_array($_FILES)) {
						...
						$uploadPath = "wp-content/uploads/bump-on-board/profile-image/";
                    ...
                    //$wpdb->query($wpdb->prepare("UPDATE wp_tblMumsDB SET md_profile_image='$image' WHERE md_wp_id=$mumid1"));

					global $table_prefix;
					$table=$table_prefix.'tblMumsDB';
					$wpdb->update($table, array('md_profile_image'=>$image), array('md_wp_id'=>$mumid1));
